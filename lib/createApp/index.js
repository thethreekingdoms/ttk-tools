...
var createApp = function () {
    var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(path) {
        var demoVersion, cloneResult, _cloneResult, res3, editNameRes, editmockRes, editstyleres, editResult;
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    ...
                    case 11:
                        ...
                        _context2.next = 15;
                        return (0, _utils.prompt)('默认安装ttk-app-core是2.0.0版本以上对应的的app。是否安装2.0.0以上的app Y/N? ');

                    case 15:
                        demoVersion = _context2.sent;
                        ...
                        _context2.next = 21;
                        return _crossSpawn2.default.sync('yarn', ['add', cloneApp + '@1.0.0'], { cwd: join(process.cwd()), stdio: 'inherit' });
