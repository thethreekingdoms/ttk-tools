...
var clone = function () {
    var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee3(cloneApp, path) {
        var cloneResult, res3, editNameRes, editmockRes, editstyleres, editResult, apps, i, appItemPath, res, runRes;
        return _regenerator2.default.wrap(function _callee3$(_context3) {
            while (1) {
                switch (_context3.prev = _context3.next) {
                    ...
                    case 56:
                        _crossSpawn2.default.sync('npm', ['start'], { cwd: join(process.cwd()), stdio: 'inherit' });
                        _context3.next = 59;
                        return process.exit();

                    case 59:
                        runRes = _context3.sent;
