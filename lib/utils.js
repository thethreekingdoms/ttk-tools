...
exports.replaceHookAppName = exports.replacePreName = exports.confirmYN = exports.inputYN = exports.getInput = exports.checkYarn = undefined;
...
var getInput = exports.getInput = function () {
    var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(warn) {
        var _null = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
var replacePreName = exports.replacePreName = function () {
    ...
    return function replacePreName(_x4, _x5) {
        return _ref5.apply(this, arguments);
    };
}();

var replaceHookAppName = exports.replaceHookAppName = function () {
    var _ref6 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee6(path, preName) {
        var arr, name;
        return _regenerator2.default.wrap(function _callee6$(_context6) {
            while (1) {
                switch (_context6.prev = _context6.next) {
                    ...
                    case 4:
                        _context6.next = 6;
                        return replaceFileAppName('./' + path + '/index.js', name, preName);

                    case 6:
                        _context6.next = 8;
                        return replaceFileAppName('./' + path + '/app.js', name, preName);

                    case 8:
                        _context6.next = 10;
                        return replaceFileAppName('./' + path + '/style.less', name, preName);

                    case 10:
                        _context6.next = 12;
                        return replaceFileAppName('./' + path + '/mock.js', path, 'testTools/ttk-hook-app-init');

                    case 12:
                        _context6.next = 14;
                        return replaceFileAppName('./' + path + '/webapi.js', path, 'testTools/ttk-hook-app-init');
    ...
    return function replaceHookAppName(_x6, _x7) {
...
function copyDir(src, dist, callback) {
    _fs2.default.access(dist, function (err) {
        if (err) {
            // 目录不存在时创建目录
            _fs2.default.mkdirSync(dist);
        }
        _copy(null, src, dist);
    });
            ...
            _fs2.default.readdir(src, function (err, paths) {
                if (err) {
                    ...
                    paths.forEach(function (path) {
                        var _src = src + '/' + path;
                        var _dist = dist + '/' + path;
                        _fs2.default.stat(_src, function (err, stat) {
                            if (err) {
                                callback(err);
                            } else {
                                // 判断是文件还是目录
                                if (stat.isFile()) {
                                    _fs2.default.writeFileSync(_dist, _fs2.default.readFileSync(_src));
...
function replaceFileAppName(file, name, preName) {
    return new _promise2.default(function (resolve, reject) {
        _fs2.default.readFile(file, function (err, data) {
            if (err) {
                console.log(_chalk2.default.redBright('\u6CA1\u6709\u53D1\u73B0' + file));
            }
            var rex = new RegExp(preName, 'g');
            var str = data.toString();
            var resultStr = str.replace(rex, name);
            _fs2.default.createWriteStream(file).write(resultStr, 'utf8', function (err) {
                if (err) {
                    resolve(false);
                    console.log(_chalk2.default.redBright('\u4FEE\u6539' + file + '\u5931\u8D25'));
                }
                resolve(true);
            });
        });
